...
public sealed class WriteOffStockRequestValidator : AbstractValidator<WriteOffStockRequest>
{
    public WriteOffStockRequestValidator()
    {
        ...
        RuleForEach(x => x.Items).ChildRules(item =>
        {
            ...
            item.RuleFor(x => x.BatchId).NotEmpty();
